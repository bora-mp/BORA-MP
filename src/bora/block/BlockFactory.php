...
class BlockFactory{
	...
	public static function registerStaticRuntimeIdMappings() : void{
		...
		$runtimeIdMap = json_decode(file_get_contents(\bora\RESOURCE_PATH . "runtimeid_table.json"), true);
		$legacyIdMap = json_decode(file_get_contents(\bora\RESOURCE_PATH . "legacy_id_map.json"), true);
