...
class CrashDump{
	...
	private function extraData(){
		...
		if($this->server->getProperty("auto-report.send-settings", true) !== false){
			...
			$this->data["bora.yml"] = @file_get_contents($this->server->getDataPath() . "bora.yml");
		}else{
			$this->data["bora.yml"] = "";
	...
	private function determinePluginFromFile(string $filePath, bool $crashFrame) : bool{
		...
		if($frameCleanPath !== "" and strpos($frameCleanPath, "src/bora/") === false and strpos($frameCleanPath, "vendor/bora/") === false and file_exists($filePath)){
			$this->addLine();
			if($crashFrame){
	...
	private function generalData(){
		...
		$this->data["general"]["base_version"] = \bora\BASE_VERSION;
		$this->data["general"]["build"] = \bora\BUILD_NUMBER;
		$this->data["general"]["is_dev"] = \bora\IS_DEVELOPMENT_BUILD;
		$this->data["general"]["protocol"] = ProtocolInfo::CURRENT_PROTOCOL;
		$this->data["general"]["git"] = \bora\GIT_COMMIT;
