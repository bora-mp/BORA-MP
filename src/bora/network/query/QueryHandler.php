...
class QueryHandler{
	...
	public function __construct(){
		...
		$this->server->getLogger()->info($this->server->getLanguage()->translateString("bora.server.query.start"));
		$addr = $this->server->getIp();
		$port = $this->server->getPort();
		$this->server->getLogger()->info($this->server->getLanguage()->translateString("bora.server.query.info", [$port]));
		/*
		...
		*/
		...
		$this->regenerateInfo();
		$this->server->getLogger()->info($this->server->getLanguage()->translateString("bora.server.query.running", [$addr, $port]));
	}
