...
use bora\event\inventory\FurnaceBurnEvent;
use bora\event\inventory\FurnaceSmeltEvent;
use bora\inventory\FurnaceInventory;
use bora\inventory\FurnaceRecipe;
use bora\inventory\Inventory;
use bora\inventory\InventoryEventProcessor;
