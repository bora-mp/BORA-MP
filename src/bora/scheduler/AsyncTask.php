...
namespace bora\scheduler;

use bora\Collectable;
use bora\Server;
 ...
 * run for a long time or infinitely, start another {@link \bora\Thread} instead.
 *
...
abstract class AsyncTask extends Collectable{
	 ...
	 * (E.g. a {@link \bora\Level} object is no longer usable because it is unloaded while the AsyncTask is
