...
class WhitelistCommand extends VanillaCommand{
	...
	public function __construct(string $name){
		parent::__construct(
			$name,
			"%bora.command.whitelist.description",
			"%commands.whitelist.usage"
		);
		$this->setPermission("bora.command.whitelist.reload;bora.command.whitelist.enable;bora.command.whitelist.disable;bora.command.whitelist.list;bora.command.whitelist.add;bora.command.whitelist.remove");
	}
	...
	private function badPerm(CommandSender $sender, string $perm) : bool{
		if(!$sender->hasPermission("bora.command.whitelist.$perm")){
